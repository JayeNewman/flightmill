...
# To import the id_lookup dataframe with two columns: id and mill which contains the unique pairings
...
#
# mill <- c("CHAMBER1", "CHAMBER2", "CHAMBER3", "CHAMBER4",
...
fm_input <- function(file_dir, file_name, sp_name) {
  ...
  #id_lookup dataframe with two columns: id and mill which contains the unique pairings
