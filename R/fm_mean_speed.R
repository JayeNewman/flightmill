#' @name fm_mean_speed
#' @title Mean speed of the flight mill chamber run
#' @description Calculates the mean bout speed for each bout
#' @param df Data frame to be modified
#' @param bout Uses the vector bout that was created in the bouts function
#' @return A data frame with flight parameters calculated for each bout.
#' @export
