...
#' @name fm_params
#' @title Calculate flight chamber parameters
...
#' @param fm_duration The length of time in seconds of the flight chamber run
...
fm_params <- function(df, chamber, elapsed_sec, counter, sector_distance, lowest_speed, min_time_interval, fm_duration)
  {
  df <- df %>%
